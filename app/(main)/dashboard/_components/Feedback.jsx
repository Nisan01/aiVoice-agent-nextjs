...
function Feedback() {
  ...
  const getAbstractImages = (option) => {
    ...
    return images ? images.icon : "/feedback.jpg";
  };
  ...
  return (
    <div className="ml-0 lg:ml-4 md:ml-4 sm:ml-4">
      ...
      {lectureData.map(
        (item, index) =>
          (item.coachingOptions === "Mock Interview" ||
            item.coachingOptions === "Ques Ans Preparation" ||
            item.coachingOptions === "Quiz Preparation") && (
